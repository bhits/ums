...
--
-- Insert i18n messages for Role
--

insert into i18n_message values (1, 'ROLE.1.NAME','Role name for patient','en', 'Patient');
insert into i18n_message values (2, 'ROLE.1.NAME','(ES)Role name for patient','es', '(ES)Patient');

insert into i18n_message values (3, 'ROLE.2.NAME','Role name for Parent','en', 'Parent');
insert into i18n_message values (4, 'ROLE.2.NAME','(ES)Role name for Parent','es', '(ES)Parent');

insert into i18n_message values (5, 'ROLE.3.NAME','Role name for Guardian','en', 'Guardian');
insert into i18n_message values (6, 'ROLE.3.NAME','(ES)Role name for Guardian','es', '(ES)Guardian');

insert into i18n_message values (7, 'ROLE.4.NAME','Role name for Provider','en', 'Provider');
insert into i18n_message values (8, 'ROLE.4.NAME','(ES)Role name for Provider','es', '(ES)Provider');

insert into i18n_message values (9, 'ROLE.5.NAME','Role name for System Support','en', 'System Support');
insert into i18n_message values (10, 'ROLE.5.NAME','(ES)Role name for System Support','es', '(ES)System Support');

insert into i18n_message values (11, 'ROLE.6.NAME','Role name for Staff','en', 'Staff');
insert into i18n_message values (12, 'ROLE.6.NAME','(ES)Role name for Staff','es', '(ES)Staff');
