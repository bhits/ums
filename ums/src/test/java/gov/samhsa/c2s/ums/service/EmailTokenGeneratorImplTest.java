...
public class EmailTokenGeneratorImplTest {
    ...
    @Test
    public void testGenerateEmailToken_whenTheUniqueTokenIsGenerated(){
        //Arrange
        String  token="token";
    ...
    @Test
    public void testGenerateEmailToken_whenUniqueTokenIsNotGenerated_ThrowsException() throws Exception{
        //Arrange
